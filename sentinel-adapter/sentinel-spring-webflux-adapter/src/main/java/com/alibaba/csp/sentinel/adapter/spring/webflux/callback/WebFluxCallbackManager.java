...
public final class WebFluxCallbackManager {
     ...
     */
    private static volatile Function<ServerWebExchange, String> originParser = DEFAULT_ORIGIN_PARSER;
    ...
    public static /*@NonNull*/ Function<ServerWebExchange, String> getOriginParser() {
        return originParser;
    }

    public static void resetOriginParser() {
        WebFluxCallbackManager.originParser = DEFAULT_ORIGIN_PARSER;
    }

    public static void setOriginParser(Function<ServerWebExchange, String> originParser) {
        AssertUtil.notNull(originParser, "originParser cannot be null");
        WebFluxCallbackManager.originParser = originParser;
    }
